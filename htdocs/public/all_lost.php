    ...
    <div class="col-lg-8 mx-auto">
      <div class="card shadow-sm p-4 mb-3" style="background: #fff9f6;">
        <form class="row g-3" method="GET" action="all_lost.php">
          ...
          <div class="col-md-3">
            <input type="text" class="form-control" name="lost_class" placeholder="Class" value="<?php echo htmlspecialchars($_GET['lost_class'] ?? ''); ?>">
          </div>
        ...
        <div class="col-md-4 col-lg-3">
          <div class="card h-100 shadow-sm">
            <?php if ($lost['PhotoURL']): ?>
              <img src="../<?php echo htmlspecialchars($lost['PhotoURL']); ?>" class="card-img-top" alt="Lost Item Image" style="object-fit:cover;max-height:180px;">
            <?php else: ?>
          ...
          <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <?php if ($lost['PhotoURL']): ?>
                  <img src="../<?php echo htmlspecialchars($lost['PhotoURL']); ?>" class="img-fluid mb-3" alt="Lost Item Image">
                <?php endif; ?>
